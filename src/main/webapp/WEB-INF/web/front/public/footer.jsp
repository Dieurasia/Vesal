...
<footer class="footer">
    <div class="foot_con">
        <div class="zhu_c clearfix">
            ...
            <div class="ul_2">
                <a href="contact.html" class="ying_tit">CONTACT</a>
                <a href="contact.html" class="a_tit">联系我们</a>
                <span>联系地址:陕西省西安市雁塔区*******    </span>
                <span>手机：<a href="#">177 1610 1908</a></span>
                <span>电话：<a href="#"> 021-31265245 </a> </span>
                <span class="icons">
				<div class="bdsharebuttonbox">
					<a href="javascript:;" data-cmd="sqq"><img src="${baseurl}/public/images/icon-qq.png" class="vcenter"
                                                               alt=""></a>
					<a href="javascript:;" data-cmd="sqq"><img src="${baseurl}/public/images/icon-qq.png" class="vcenter"
                                                               alt=""></a>
					<a href="javascript:;" data-cmd="sqq"><img src="${baseurl}/public/images/icon-qq.png" class="vcenter"
                                                               alt=""></a>
					<a href="javascript:;" class="bds_more" data-cmd="more"><img src="${baseurl}/public/images/icon-jia.png"
                                                                                 class="vcenter" alt=""/></a>
				</div>
